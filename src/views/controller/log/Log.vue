          ...
          <template #default="scope">
            ...
            >
              <template v-slot:content>
                <p style="max-width: 150px;word-break: break-all">
                  {{ scope.row.content }}
                </p>
              </template>
              <p style="display: -webkit-box;-webkit-line-clamp: 3;-webkit-box-orient: vertical;width: 151px">
                {{ scope.row.content }}
              </p>
            </el-tooltip>
          </template>
